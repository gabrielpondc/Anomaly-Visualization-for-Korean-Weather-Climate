...
<div id="container2" style="width: 100%;height: 250px;width: auto"></div>
  ...
  Select Date <input class="input" type="date"  value-format="yyyy-MM-dd HH:mm" format="yyyy-MM-dd HH:mm" id="date" placeholder="Select date">
  <button id="btn2" class='pt' onclick="acc()">
  <div class="svg-wrapper-1">
    <div class="svg-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
  ...
  .then(({ data }) => {
   ...
   return;
    ...
    var getting4={
                ...
                async: true,
                timeout: 10000000,
                url: './xin1.php?&date=<?php echo $date ?>',
                datatest: {},
                dataType: "json",
                success: function(result){
    ...
    function acc(){
              ...
              window.location.href="?date="+date1; 
    }
    function acc2(){
