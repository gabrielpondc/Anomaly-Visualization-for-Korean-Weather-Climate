...
$end_time=$_GET['end'];
$date=$_GET['date'];
$cmd=$set_charset.'/usr/bin/python3 /media/ubuntu/Newdisk/xyo/admin/aacc_80/wwwroot/eachcity.py '.$start_time.' '.$end_time.' '.$date.' 2>error.txt';
